...
function PitScoutingForm() {
    ...
    const [tbaTeam, setTbaTeam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PitScoutingForm.useEffect": ()=>{
            const fetchTeamFromTBA = {
                "PitScoutingForm.useEffect.fetchTeamFromTBA": async ()=>{
                    if (formData.team_number.length >= 1) {
                        setTbaLoading(true);
                        try {
                            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tba$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTBAData"])(`/team/frc${formData.team_number}`);
                            setTbaTeam(data);
                        } catch (err) {
            ...
            }["PitScoutingForm.useEffect.fetchTeamFromTBA"];
            const timer = setTimeout({
                "PitScoutingForm.useEffect.timer": ()=>{
                    if (formData.team_number) {
                        fetchTeamFromTBA();
                    }
                }
            }["PitScoutingForm.useEffect.timer"], 800) // Debounce
            ;
            return ({
                "PitScoutingForm.useEffect": ()=>clearTimeout(timer)
            })["PitScoutingForm.useEffect"];
        }
    }["PitScoutingForm.useEffect"], [
...
_s(PitScoutingForm, "P05EgZ0zoPOIxRUXupUqZvk75D0=");
_c = PitScoutingForm;
var _c;
__turbopack_context__.k.register(_c, "PitScoutingForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_879eadbf._.js.map