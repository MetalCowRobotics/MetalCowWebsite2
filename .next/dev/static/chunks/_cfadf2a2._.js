...
function DropdownMenuLabel({ className, inset, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$base$2d$ui$2f$react$2f$esm$2f$menu$2f$index$2e$parts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Menu$3e$__["Menu"].GroupLabel, {
        ...
        "data-inset": inset,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-muted-foreground px-3 py-2.5 text-xs data-inset:pl-9.5", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/components/ui/dropdown-menu.tsx",
        lineNumber: 65,
        ...
        "Navbar.useEffect": ()=>{
            const getUser = {
                "Navbar.useEffect.getUser": async ()=>{
                    ...
                    if (session?.user) {
                        const adminStatus = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAdmin"])(session.user.email, session.user.id);
            ...
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "Navbar.useEffect": (_event, session)=>{
                    setUser(session?.user ?? null);
                    if (session?.user) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAdmin"])(session.user.email, session.user.id).then(setIsAdminUser);
                    } else {
...
_s(Navbar, "fsra4C8OFeoKbBxyqYolRAKBR7s=", false, function() {
    return [
...
//# sourceMappingURL=_cfadf2a2._.js.map