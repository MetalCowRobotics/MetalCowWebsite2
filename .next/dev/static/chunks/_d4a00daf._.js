...
function ScoutLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScoutLayout.useEffect": ()=>{
            const checkUser = {
                "ScoutLayout.useEffect.checkUser": async ()=>{
                    const { data: { session } } = await supabase.auth.getSession();
                    if (!session) {
                        router.push('/login?redirect=/scout/match'); // Default to match scouting
                        return;
                    }
                    setAuthenticated(true);
                    setLoading(false);
                }
            }["ScoutLayout.useEffect.checkUser"];
            checkUser();
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "ScoutLayout.useEffect": (_event, session)=>{
                    if (!session) {
                        router.push('/login');
                    } else {
                        setAuthenticated(true);
            ...
            return ({
                "ScoutLayout.useEffect": ()=>subscription.unsubscribe()
            })["ScoutLayout.useEffect"];
        }
    }["ScoutLayout.useEffect"], [
        router,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: "Authenticating Scouter..."
                }, void 0, false, {
                    fileName: "[project]/app/scout/layout.tsx",
                    lineNumber: 48,
                    columnNumber: 17
...
_s(ScoutLayout, "uBYcQPP6e6d2epyOlbt6OkIcg44=", false, function() {
    return [
...
//# sourceMappingURL=_d4a00daf._.js.map