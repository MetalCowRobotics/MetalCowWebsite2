...
"[project]/components/scouting/MatchScoutingForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeamNameSearch({ query, eventKey, onSelect }) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamNameSearch.useEffect": ()=>{
            if (query.length < 2) {
                setResults([]);
                return;
            }
            const searchTeams = {
                "TeamNameSearch.useEffect.searchTeams": async ()=>{
                    setLoading(true);
                    try {
                        const teams = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tba$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTBAData"])(`/event/${eventKey}/teams`);
                        const matches = teams.filter({
                            "TeamNameSearch.useEffect.searchTeams.matches": (t)=>t.nickname?.toLowerCase().includes(query.toLowerCase()) || t.team_number?.toString().includes(query)
                        }["TeamNameSearch.useEffect.searchTeams.matches"]).slice(0, 8);
                        setResults(matches);
                    } catch (e) {
                        setResults([]);
                    } finally{
            ...
            }["TeamNameSearch.useEffect.searchTeams"];
            const timer = setTimeout(searchTeams, 300);
            return ({
                "TeamNameSearch.useEffect": ()=>clearTimeout(timer)
            })["TeamNameSearch.useEffect"];
        }
    }["TeamNameSearch.useEffect"], [
        query,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            results.map((team)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    type: "button",
...
_s1(TeamNameSearch, "VuTAnq2hL4HZo3dPAiLmxU/AKWE=");
_c1 = TeamNameSearch;
// Define the steps
const STEPS = {
    PREMATCH: 0,
...
function MatchScoutingForm() {
    ...
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(STEPS.PREMATCH);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [increment, setIncrement] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MatchScoutingForm.useEffect": ()=>{
            const fetchUser = {
                "MatchScoutingForm.useEffect.fetchUser": async ()=>{
                    ...
                    if (nameToUse) {
                        setFormData({
                            "MatchScoutingForm.useEffect.fetchUser": (prev)=>({
                                    ...prev,
                                    scout_name: nameToUse
                                })
                        }["MatchScoutingForm.useEffect.fetchUser"]);
                    }
                }
            }["MatchScoutingForm.useEffect.fetchUser"];
            fetchUser();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MatchScoutingForm.useEffect": ()=>{
            setFormData({
                "MatchScoutingForm.useEffect": (prev)=>({
                        ...prev,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MatchScoutingForm.useEffect": ()=>{
            const fetchTeams = {
                "MatchScoutingForm.useEffect.fetchTeams": async ()=>{
                    try {
                        ...
                        setValidTeams(teams.map({
                            "MatchScoutingForm.useEffect.fetchTeams": (t)=>t.team_number
                        }["MatchScoutingForm.useEffect.fetchTeams"]).sort({
                            "MatchScoutingForm.useEffect.fetchTeams": (a, b)=>a - b
                        }["MatchScoutingForm.useEffect.fetchTeams"]));
                        setFormData({
                            "MatchScoutingForm.useEffect.fetchTeams": (prev)=>({
                                    ...prev,
                                    team_number: ''
                                })
                        }["MatchScoutingForm.useEffect.fetchTeams"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MatchScoutingForm.useEffect": ()=>{
            const detectEvent = {
                "MatchScoutingForm.useEffect.detectEvent": async (lat, lon)=>{
                    try {
                        const year = 2026 // Using the user's requested season
                        ;
                        const events = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tba$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTBAData"])(`/events/${year}`);
                        const now = new Date();
                        // Find events happening now (within start/end dates)
                        const activeEvents = events.filter({
                            "MatchScoutingForm.useEffect.detectEvent.activeEvents": (e)=>{
                        ...
                        if (activeEvents.length > 0) {
                            ...
                            }["MatchScoutingForm.useEffect.detectEvent"]);
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition({
                    "MatchScoutingForm.useEffect": (pos)=>detectEvent(pos.coords.latitude, pos.coords.longitude)
                }["MatchScoutingForm.useEffect"], {
                    "MatchScoutingForm.useEffect": (err)=>console.log('Geolocation declined or failed:', err.message)
                }["MatchScoutingForm.useEffect"]);
            }
        }
    }["MatchScoutingForm.useEffect"], []);
    ...
    const filteredTeams = validTeams.filter((num)=>num.toString().startsWith(formData.team_number)).slice(0, 5); // Show top 5 matches
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        className: "space-y-4",
                        children: [
                            step === STEPS.PREMATCH && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                                ...
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(validTeams.length > 0 && formData.team_number && /^\d+$/.test(formData.team_number) && !validTeams.includes(parseInt(formData.team_number)) ? "border-destructive focus-visible:ring-destructive" : "")
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                lineNumber: 436,
                                                                columnNumber: 41
                                                            }, this),
                                                            formData.team_number && !/^\d+$/.test(formData.team_number) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TeamNameSearch, {
                                                            ...
                                                            validTeams.length > 0 && formData.team_number && /^\d+$/.test(formData.team_number) && !validTeams.includes(parseInt(formData.team_number)) && filteredTeams.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    filteredTeams.map((num)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                            type: "button",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                                htmlFor: "robot_on_field",
                                                className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70",
                                                children: "Robot on Field?"
                                            }, void 0, false, {
                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                lineNumber: 542,
                                                columnNumber: 33
                            ...
                            step === STEPS.AUTO && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-4 animate-in slide-in-from-right-8 fade-in-0 duration-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Button"], {
                                                                ...
                                                                size: "icon",
                                                                className: "shrink-0",
                                                                onClick: ()=>handleInputChange('auto_fuel_scored', Math.max(0, formData.auto_fuel_scored - increment)),
                                                                children: "-"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                lineNumber: 595,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Button"], {
                                                                ...
                                                                size: "icon",
                                                                className: "shrink-0",
                                                                onClick: ()=>handleInputChange('auto_fuel_scored', Math.min(500, formData.auto_fuel_scored + increment)),
                                                                children: "+"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                lineNumber: 604,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                                        children: "Start Position - Click on the field to select"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                        lineNumber: 609,
                                                        columnNumber: 37
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                        src: formData.alliance === 'Red' ? '/2026-field-images/red-alliance-wall2.jpg' : '/2026-field-images/blue-alliance-wall.jpg',
                                                                        alt: "Field Map",
                                                                    ...
                                                                    [
                                                                        ...
                                                                        },
                                                                        {
                                                                            ...
                                                                            className: `absolute px-4 py-3 -translate-x-1/2 -translate-y-1/2 rounded-xl border-4 font-black text-sm transition-all transform hover:scale-110 shadow-lg ${formData.start_position === pos.id ? formData.alliance === 'Red' ? 'bg-red-600 border-red-400 text-white shadow-red-600/50 scale-110' : 'bg-blue-600 border-blue-400 text-white shadow-blue-600/50 scale-110' : 'bg-background/90 border-muted-foreground text-muted-foreground hover:border-primary hover:bg-primary/10'}`,
                                                                            style: {
                                                                                top: pos.top,
                                                                                left: pos.left
                                                                            },
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "mt-2 flex justify-center gap-8 text-xs text-muted-foreground",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: formData.start_position === 'Left' ? (formData.alliance === 'Blue' ? 'text-blue-600' : 'text-red-600') + ' font-bold' : '',
                                                                        children: "Left"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                        lineNumber: 639,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: formData.start_position === 'Center' ? 'text-primary font-bold' : '',
                                                                        children: "Center"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                        lineNumber: 640,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: formData.start_position === 'Right' ? (formData.alliance === 'Blue' ? 'text-blue-600' : 'text-red-600') + ' font-bold' : '',
                                                                        children: "Right"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                        lineNumber: 641,
                            ...
                            step === STEPS.TELEOP && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-4 animate-in slide-in-from-right-8 fade-in-0 duration-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Button"], {
                                                                ...
                                                                size: "icon",
                                                                className: "shrink-0",
                                                                onClick: ()=>handleInputChange('teleop_fuel_scored', Math.max(0, formData.teleop_fuel_scored - increment)),
                                                                children: "-"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                lineNumber: 686,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Button"], {
                                                                ...
                                                                size: "icon",
                                                                className: "shrink-0",
                                                                onClick: ()=>handleInputChange('teleop_fuel_scored', Math.min(1000, formData.teleop_fuel_scored + increment)),
                                                                children: "+"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/scouting/MatchScoutingForm.tsx",
                                                                lineNumber: 695,
                            ...
                            step === STEPS.ENDGAME && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-4 animate-in slide-in-from-right-8 fade-in-0 duration-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-[10px] font-bold uppercase tracking-wider", formData.comments.length >= 180 ? "text-destructive" : "text-muted-foreground"),
                                                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: Object.values(STEPS).filter((s)=>typeof s === 'number' && s < 4).map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s2(MatchScoutingForm, "JfSqS0umceenAH7U9NLXypoqbNo=", false, function() {
    return [
...
_c2 = MatchScoutingForm;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "TeamNickname");
__turbopack_context__.k.register(_c1, "TeamNameSearch");
__turbopack_context__.k.register(_c2, "MatchScoutingForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_88631561._.js.map